...
reportPrice int(20));
insert into purchase_report values(1,"Strickrer","18211a0406@bvrit.ac.in","18-10-2000",399);
...
insert into user values(1,"Sandeep","18211a0406@bvrit.ac.in",21,"male","D Honnur");
select * from user;
